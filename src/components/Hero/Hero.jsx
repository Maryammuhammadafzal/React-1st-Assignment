...
import Profile_Image from '../../assets/my-image/full-profile-Image.webp'
...
function Hero() {
  ...
  return (
    ...
    <>
        ...
        <div className="w-1/2 h-full flex flex-col justify-center items-center bg-gray-400">
        ...
        <div className='w-1/2 h-full flex flex-col justify-center items-center bg-slate-700'>
        <img className="w-[526px] h-[585px] left-[982px] top-[347.50px] absolute " src={Banner_Image} />
        <img className="w-[456px] h-[502.11px] left-[1117px] top-[382.50px] " src={Profile_Image} />
        </div>
       </div> 
      

      {/* <Navbar/>
    <div className="h-36 flex-col justify-center items-center flex">
      <div><span class="text-white text-6xl font-bold font-['Poppins'] uppercase leading-[72px]">HI, I'M ZYAN!<br/>Creative </span><span class="text-[#55e6a5] text-6xl font-black font-['Poppins'] uppercase leading-[72px]">Player</span></div>
    </div>
